  ...
  cancelTemplates: [
    {
      ...
      lang: "日本語",
      enabled: true,
      body: "無料キャンセルは {{ freeCancelDeadline }} まで可能です。{{ cancellationFeeStart }} 以降は {{ cancellationFeeRate }} のキャンセル料が発生します。",
      note: "全TourOption共通の既定テンプレート。",
      updatedAt: "2024/01/15",
    },
    {
      id: "ct_02STD_EN",
      name: "Standard Policy (English)",
      lang: "English",
      enabled: true,
      body: "Free cancellation is available until {{ freeCancelDeadline }}. A cancellation fee of {{ cancellationFeeRate }} applies after {{ cancellationFeeStart }}.",
      note: "English-facing OTA listings.",
